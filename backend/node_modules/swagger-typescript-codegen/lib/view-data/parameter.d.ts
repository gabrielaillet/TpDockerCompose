...
export declare const getParametersForMethod: (globalParams: ReadonlyArray<Parameter>, params: ReadonlyArray<Parameter> | undefined, swagger: Swagger) => TypeSpecParameter[];
