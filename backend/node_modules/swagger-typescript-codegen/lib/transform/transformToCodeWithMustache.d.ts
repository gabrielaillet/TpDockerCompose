...
export declare type Templates = Record<keyof Template, string>;
declare type Renderer = {
    readonly render: (template: string, view: any, partials?: any, tags?: string[]) => string;
    escape?: (value: string) => string;
};
export declare function transformToCodeWithMustache<T, C extends {}>(data: T, templates: Partial<Templates>, additionalViewOptions?: Partial<C>, codeRenderer?: Renderer): string;
export {};
