declare type SwaggerTypes = "object" | "string" | "boolean" | "number" | "integer" | "array" | "enum" | "schema" | "reference";
...
export declare type PathAndMethodTupleWithPathParams = [string, HttpMethod, HttpOperation, ReadonlyArray<Parameter>];
export {};
